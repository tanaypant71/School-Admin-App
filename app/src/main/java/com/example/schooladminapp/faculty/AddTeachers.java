...
import com.example.schooladminapp.faculty.notice.NoticeData;
...
public class AddTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category","English","Hindi","Maths"};
        ...
        addTeacherBtn.setOnClickListener(view -> checkValidation());
    }
